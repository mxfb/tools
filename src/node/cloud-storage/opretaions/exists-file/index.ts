...
import { exists as ftpExists } from 'node/ftps/file/exists'
import { exists as sftpExists } from 'node/sftp/file/exists'
import { ExistsOptions as S3ExistsOptions, exists as s3Exists } from 'node/@aws-s3/storage/file/exists'
import { ExistsOptions as GcsExistsOptions, exists as gcsExists } from 'node/@google-cloud/storage/file/exists'
