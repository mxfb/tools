...
import { UploadOptions as FtpUploadOptions, upload as ftpUpload } from 'node/ftps/file/upload'
import { UploadOptions as SftpUploadOptions, upload as sftpUpload } from 'node/sftp/file/upload'
import { UploadOptions as S3UploadOptions, upload as s3Upload } from 'node/@aws-s3/storage/file/upload'
import { UploadOptions as GcsUploadOptions, upload as gcsUpload } from 'node/@google-cloud/storage/file/upload'
