...
import { copyDir as ftpCopyDir } from 'node/ftps/directory/copy-dir'
import { copyDir as sftpCopyDir } from 'node/sftp/directory/copy-dir'
import { CopyDirOptions as S3CopyDirOptions, copyDir as s3CopyDir } from 'node/@aws-s3/storage/directory/copy-dir'
import { CopyDirOptions as GcsCopyDirOptions, copyDir as gcsCopyDir } from 'node/@google-cloud/storage/directory/copy-dir'
...
export async function copyDir (client: FtpClient, sourcePath: string, targetPath: string): Promise<Returned>
export async function copyDir (client: SftpClient, sourcePath: string, targetPath: string): Promise<Returned>
export async function copyDir (client: AnyClient, sourcePath: string, targetPath: string, options?: GcsCopyDirOptions | S3CopyDirOptions): Promise<Returned> {
