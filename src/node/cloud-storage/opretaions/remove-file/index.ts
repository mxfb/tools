...
import { RemoveOptions as FtpRemoveOptions, remove as ftpRemove } from 'node/ftps/file/remove'
import { RemoveOptions as SftpRemoveOptions, remove as sftpRemove } from 'node/sftp/file/remove'
import { RemoveOptions as S3RemoveOptions, remove as s3Remove } from 'node/@aws-s3/storage/file/remove'
import { RemoveOptions as GcsRemoveOptions, remove as gcsRemove } from 'node/@google-cloud/storage/file/remove'
